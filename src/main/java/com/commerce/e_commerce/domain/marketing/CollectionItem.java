...
@Entity
@Table(name="collection_item", indexes=@Index(name="idx_colitem_collection", columnList="collection_id"))
@Getter
@Setter
public class CollectionItem extends BaseEntity {
    ...
    private String imageUrl; // ürün için koleksiyon özel görseli istenirse
}
